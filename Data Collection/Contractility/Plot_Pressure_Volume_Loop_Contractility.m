...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% For final changes to contractility
a1_final = Variable_ESPVR_A1(1,end);
a0_final = a0;

Pa_final = a1_final*V + a0_final;
plot(V,Pa_final,'LineWidth',2,...
	'Color',[0.313725501298904 0.313725501298904 0.313725501298904])
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
% Plot PV Loop
...
legend('ESPVR: Initial', 'ESPVR: Final', 'EDPVR', 'Ea', 'Pressure-Volume Loop')
title('Left Ventricular Pressure-Volume Loop - Contractility Change Only');
...
% save(['PV_Loop_Contractility _Only_002.mat'])
% 
% fig1 = figure(n);
% fig2 = figure(n+1);
% 
% savefig(fig1, ['Figure_1_Contractility_Only_002.fig']);
% savefig(fig2, ['Figure_2_Contractility_Only_002.fig']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
