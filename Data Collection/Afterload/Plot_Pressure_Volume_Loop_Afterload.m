...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% For final changes to afterload
...
title('Left Ventricular Pressure-Volume Loop - Afterload Change Only');
...
% save(['PV_Loop_Afterload_Only_002.mat'])
% 
% fig1 = figure(n);
% fig2 = figure(n+1);
% 
% savefig(fig1, ['Figure_1_Afterload_Only_002.fig']);
% savefig(fig2, ['Figure_2_Afterload_Only_002.fig']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
