...
legend('ESPVR', 'EDPVR', 'Ea', 'Pressure-Volume Loop')
...
% save(['PV_Loop_No_Change_002.mat'])
% 
% fig1 = figure(n);
% fig2 = figure(n+1);
% 
% savefig(fig1, ['Figure_1_No_Change_002.fig']);
% savefig(fig2, ['Figure_2_No_Change_002.fig']);
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
