...
%  Date: 8/24/2018
%
%  HFNEF - Westermann et al. "Role of Left Ventricular Stiffness..." 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Input Variables
% Initial
%ESPVR
...
title('Left Ventricular Pressure-Volume Loop - HFNEF');
...
% save(['PV_Loop_Westermann_HFNEF_002.mat'])
% 
% fig1 = figure(n);
% fig2 = figure(n+1);
% 
% savefig(fig1, ['Figure_1_Westermann_HFNEF_002.fig']);
% savefig(fig2, ['Figure_2_Westermann_HFNEF_002.fig']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
